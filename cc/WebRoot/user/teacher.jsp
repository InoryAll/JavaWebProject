					...
					<table class="search_table add_table" id="add_table">
						...
						<tbody>
							...
							<tr class="active">
								...
								<td>
									<div class="add_input_div">
										<input type="text" name="info" placeholder="请输入课程简介">
									</div>
								</td>
								<td>
			...
			$.ajax({
				...
				success:function(data){
					...
					for(var i=0;i<data.length;i++){
						if(i%2!=0)
						{
							insertNode=$('<tr class="single"><td>'+data[i].id+'</td><td>'+data[i].name+'</td><td>'+data[i].teacherId+'</td><td>'+data[i].teacherName+'</td><td>'+data[i].date+'</td><td>'+data[i].info+'</td><td></td></tr>');
						}
						else
						{
							insertNode=$('<tr class="double"><td>'+data[i].id+'</td><td>'+data[i].name+'</td><td>'+data[i].teacherId+'</td><td>'+data[i].teacherName+'</td><td>'+data[i].date+'</td><td>'+data[i].info+'</td><td></td></tr>');
						}
