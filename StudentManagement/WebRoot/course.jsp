	...
	<div id="main">
		<div id="main_content">
			<form action="useraction" method="post">
				<input type="hidden" name="action" id="action" value="insert_course">
				<input type="hidden" name="start" value=0>
				<input type="hidden" name="amount" value=2>
				<table class="student_select_table" id="student_select_table">
					<thead>
						<tr>
							<th>课号</th>
							<th>课名</th>
						...
						<%
							if(course_list!=null)
							{
								for(i=0;i<course_list.size();i++)
								{
									...
									out.println("<input type=\"submit\""+" id=\"course_select_submit\""+"value='提&nbsp;&nbsp;交'>");
									out.println("</td>");	
									out.println("</tr>");	
							}
						 %>
